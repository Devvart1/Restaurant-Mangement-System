...
1. 2k20/IT/41 - Devvart
2. 2k20/IT/42 - Dharamveer

*/


#include<stdio.h> //This header file includes functions involving memory allocation, process control, conversions and others.
 #include<string.h>    //This header file includes string functions.
#include <windows.h>
#include <time.h>
#include <conio.h>//This header file provides basic I/O operations for program
//In this program we have implemented Linked List to perform various tasks.
struct node //This is the structure which provides a template for node of Linked List. It shows a representation of a food item in men
{                                             // It contains different attributes of node such as it's food name, gauntity, price, data, pointer to next node and pointer to previous node.
    char foodname[50];
    int quantity;
    float price;
    int data;
...
//Here in order to perform various task of admin as well as customer using one single structure, we have created one single structure

//catering to purpose of menu item as well as customer's order.


struct node *headc = NULL, *newnode, *tailc = NULL;      //global struct pointers which are used throughout the program to create linked list and maintain it.
...
void mainnenu()
{
    ...
    printf("\t\t\t\t\t\t\t1. ADMIN SECTION(Lodin credentials required)--> \n");
...
int main()
{
    ...
    printf("\t\t\t\t@@|                                    WELCOME TO                                         |@@\n");
    printf("\t\t\t\t@@|                                                                                       |@@\n");
    printf("\t\t\t\t@@|                  \xB3\xB2=\xB2=\xB2-\xB3 RESTAURANT MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3                      |@@\n");
    printf("\t\t\t\t@@|                                                                                       |@@\n");
    printf("\t\t\t\t@@|                                                                                       |@@\n");
    printf("\t\t\t\t@@|                                                                                       |@@\n");
    printf("\t\t\t\t@@|                                                                                       |@@\n");
    printf("\t\t\t\t@@|                                       -Brought To You by DEVVART     2k20/IT/41       |@@\n");
    printf("\t\t\t\t@@|                                                      and DHARAMVEER  2k20/IT/42       |@@\n");
    printf("\t\t\t\t@@|_______________________________________________________________________________________|@@\n");
    printf("\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t");
    ...
    heada = createadmin(heada, 6, "Afghan Jalebi", 400);
